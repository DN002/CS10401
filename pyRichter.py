...
#Your first and last name: Chris Aromando
#Your ID: 1171536
...
#   elseIf(userRichter less than 4.5, output "Damage to poorly constructed buildings"
#   elseIf(userRichter greater than equal to 4.5 but less than 6.0, output "Damage to poorly constructed buildings")
#   elseIf(userRichter greater than equal to 6.0 but less than 7.0, output "Many buildings considerably damaged, some collapse")
#   elseIf(userRichter greater than equal to 7.0 but less than 8.0, output "Many buildings destroyed")
#   elseIf(userRichter greater than or equal to 8.0, output "Most structures fall")
